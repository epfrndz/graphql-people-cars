...
mutation AddPerson($firstName: String!, $lastName: String, $addPersonId: String) {
...
mutation UpdateCar($updateCarId: String!, $personId: String!, $year: String!, $make: String!, $model: String!, $price: Float!) {
  updateCar(id: $updateCarId, personId: $personId, year: $year, make: $make, model: $model, price: $price) {
    id
    personId
    year
    make
...
mutation AddCar($personId: String!, $year: String!, $make: String!, $model: String!, $price: Float!, $addCarId: String) {
  addCar(personId: $personId, year: $year, make: $make, model: $model, price: $price, id: $addCarId) {
    id
    personId
    year
    make
